Data Dictionary for data used in:

Hagy, JD, B. Kreakie, M. Pelletier, F. Nojavan, J. Kiddon, and A. Oczkowski.  2021. 
Quantifying coastal ecosystem condition and a trophic state index with a Bayesian 
analytical framework (in review)
...
CoastalWQ_20200831.csv 
   Includes data from EPA's National Coastal Condition Assessments in 2021 and 2015.
...
MEAN_SECCHI_DEPTH (m)   Average of secchi depth measurements (meters)
...
Depth.to.bottom..m.                      		Water depth (m)
...
Surface.or.Bottom                       		depth layer of samples (S= Surface, B= Bottom)
Sample.depth..m.                  			Depth where sample was collected (meters)
...
Chlorophyll.a..ug.L.              			Chlorophyll-a (micrograms per liter)
Chlorophyll.....or....           			Chlorophyll-a below detection limit (<)
Phaeophytin..ug.L.                			Phaeophytin (micrograms per liter)
