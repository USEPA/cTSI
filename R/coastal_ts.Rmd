...
if (!file.exists("data/Bayesian_POLR_2010.Rdata")) {
  save(Coeff.Summary.L3Eco,Model,Evaluation,file="data/Bayesian_POLR_2010.Rdata")
}
...
pdf("figures/POLR_Prob_2010L3Eco.pdf", width=6, height=6, paper="letter")
  print(plt)
dev.off()
...
if (!file.exists("data/coastal_jags_update_L3Eco.Rdata")) {
  save(coastal_jags_update_L3Eco,file="data/coastal_jags_update_L3Eco.Rdata")
}
```
...
if (!file.exists("data/Bayesian_POLR_2015update.(7-22-21).Rdata")) {
  save(Coeff.Summary.update.L3Eco,Model,Evaluation,file="data/Bayesian_POLR_2015update.Rdata")
}
