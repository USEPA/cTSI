...
variableLabels <- c("TN","DIN","TP","DIP","DIN:DIP","TN:TP","Secchi","Latitude","Longitude","Region","Level III","AggEco","EMAP","BioGeo")
...
pdf("figures/varImpRFall_2010.pdf",width=8,height = 10,paper="letter", onefile=TRUE)
   plt_all_RF
dev.off()
...
if (!file.exists("data/Bayesian_POLR_2010.(7-22-21).Rdata")) {
  save(Coeff.Summary.L3Eco,Model,Evaluation,file="data/Bayesian_POLR_2010.(7-22-21).Rdata")
}
...
pdf("figures/POLR_Prob_2010L3Eco.(7-22-21).pdf", width=6, height=6, paper="letter")
  print(plt)
dev.off()
...
# Start the clock!
ptm <- proc.time()
coastal_jags_update_L3Eco <- jags.model('R/coastal_jags.R',data = DataList 
                           , inits, n.chains = nChains, n.adapt = adaptSteps)
# Stop the clock
proc.time() - ptm
...
save(coda_update_L3Eco,file="coda_update_L3Eco.(7-22-21).Rdata")
...
if (!exists("coda_update_L3Eco")) {
 load("data/coda_update_L3Eco.Rdata")  
}
...
if (!file.exists("data/Bayesian_POLR_2015update.(7-22-21).Rdata")) {
  save(Coeff.Summary.update.L3Eco,Model,Evaluation,file="data/Bayesian_POLR_2015update.(7-22-21).Rdata")
}
...
write.csv(cbind(Coeff.Summary.L3Eco,Coeff.Summary.update.L3Eco),
          file="outputs/POLR_Model_Parameters.csv")
...
pdf("figures/POLR_Prob_2015L3Eco.(7-23-21).pdf", width=6, height=6, paper="letter")
   print(plt)
invisible(dev.off())
