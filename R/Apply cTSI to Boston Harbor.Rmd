...
pdf(file="figures/QGAM Chla figure.pdf",width=4,height=4,useDingbats = FALSE,paper="letter")
  chla_Qgam_plt +
      labs(x="",y="")+
      theme(
...
pdf(file="figures/QGAM TSI figure.pdf",width=4,height=4,useDingbats = FALSE,paper="letter")
  TSI_Qgam_plt+
      labs(x="",y="")+
      theme(
        axis.text=element_blank(),
