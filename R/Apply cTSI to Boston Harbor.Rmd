...
if (!file.exists("data/Boston_POLR_Data(7-27-21).Rdata")) {
save(bh_polr,file="data/Boston_POLR_Data(7-27-21).Rdata")
}
```
...
load("data/Boston_POLR_Data(7-27-21).Rdata")
...
load("data/Bayesian_POLR_2015update.(7-22-21).Rdata")
load("data/Bayesian_POLR_2010.(7-22-21).Rdata")
...
bh$Hypertrophic <- tmp$pHypertrophic

save(bh,file="data/BostonHarborTSI (7-30-21).Rdata")
write.csv(bh,file="outputs/BH_TSI (7-30-21).csv",row.names=FALSE)
```
...
load("data/BostonHarborTSI (7-30-21).Rdata")
...
pdf(file="figures/QGAM Chla figure(7-27-21).pdf",width=4,height=4,useDingbats = FALSE,paper="letter")
  chla_Qgam_plt +
      labs(x="",y="")+
      theme(
...
pdf(file="figures/QGAM TSI figure(8-3-21).pdf",width=4,height=4,useDingbats = FALSE,paper="letter")
  TSI_Qgam_plt+
      labs(x="",y="")+
      theme(
        axis.text=element_blank(),
