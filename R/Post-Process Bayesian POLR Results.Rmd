...
pdf("figures/Parameter_Comparison(2022_03_02).pdf",width=8,height = 4,paper="letter")
   plt
dev.off()
...
lines2010 <- build_lines_scaled(Coeff.Summary.L3Eco[1:25,],c(-7,7)) %>% 
...
save(coastal,file="data/coastalTSI(2022_03_01).Rdata")
write.csv(coastal,file="outputs/coastalTSI(2022_03_01).csv",row.names=FALSE)
...
pdf(file="figures/Nutrient vs Region w Case Study(2022_03_01).pdf",
...
nl <- theme(legend.position="none")
pdf(file="figures/ProbPlotsStacked.wBar.withData(2022_03_01).pdf",width=4,height=7,paper="letter",useDingbats = FALSE)
